...
const qualityLenses = [
  {
    ...
    objective:
      "เป้าหมาย: โปรเจกต์นี้ช่วยสร้าง Student Agency และทักษะแห่งอนาคตเพื่อความสุขสมบูรณ์ (Well-being) หรือไม่?",
    items: [
      {
        id: "student_agency",
        label:
          "1. ความเป็นเจ้าของการเรียนรู้ (Student Agency): ผู้เรียนได้ตั้งเป้าหมาย ลงมือทำ และตัดสินใจด้วยตนเอง โดยไม่ได้เป็นเพียงผู้รับความรู้ฝ่ายเดียว",
      },
      {
        id: "co_agency",
        label:
          "2. การทำงานร่วมกัน (Co-agency): มีการออกแบบให้ผู้เรียนทำงานร่วมกับเพื่อน ครู ครอบครัว หรือชุมชน",
      },
      {
        id: "core_foundations",
        label:
          "3. รากฐานที่แข็งแรง (Core Foundations): ส่งเสริมทักษะพื้นฐาน สุขภาพกาย/จิต และสังคมอารมณ์",
      },
      {
        id: "skills_meta",
        label:
          "4. ทักษะและการรู้คิด (Skills & Meta-cognitive): มีการฝึกคิดวิเคราะห์ คิดสร้างสรรค์ และรู้เท่าทันการเรียนรู้ของตนเอง",
      },
      {
        id: "creating_new_value",
        label:
          "5. การสร้างคุณค่าใหม่ (Creating New Value): ผู้เรียนได้คิดค้นนวัตกรรม วิธีการใหม่ หรือมองเห็นโอกาสจากปัญหา",
      },
      {
        id: "reconciling_tensions",
        label:
          "6. การรับมือกับความขัดแย้ง (Reconciling Tensions): มีการฝึกคิดเชิงระบบเพื่อหาจุดสมดุลระหว่างสิ่งที่ขัดแย้งกัน",
      },
      {
        id: "taking_responsibility",
        label:
          "7. การรับผิดชอบต่อการกระทำ (Taking Responsibility): ผู้เรียนสามารถประเมินผลกระทบ กล้าตัดสินใจ และรับผิดชอบต่อสังคม",
      },
      {
        id: "aar_cycle",
        label:
          "8. วัฏจักรการเรียนรู้ (AAR Cycle): โปรเจกต์มีกระบวนการให้ผู้เรียน คาดการณ์ -> ลงมือทำ -> สะท้อนคิด",
      },
    ],
  },
  {
    ...
    objective:
      "เป้าหมาย: โปรเจกต์นี้ปลูกฝังทัศนคติที่ถูกต้อง พื้นฐานชีวิตที่มั่นคง การมีอาชีพ และความเป็นพลเมืองดี หรือไม่?",
    items: [
      {
        id: "right_attitude",
        label:
          "1. ทัศนคติที่ถูกต้อง (Right Attitude): มีการสอดแทรกความรู้ความเข้าใจในบริบทสังคม ประวัติศาสตร์ และสร้างความรักความผูกพันกับท้องถิ่น",
      },
      {
        id: "stable_life",
        label:
          "2. พื้นฐานชีวิตที่มั่นคง (Stable Life): มีการฝึกให้ผู้เรียนรู้จักแยกแยะผิดชอบชั่วดี มีวินัยในตนเอง และปฏิเสธสิ่งไม่ดีได้",
      },
      {
        id: "resilience",
        label:
          "3. ความมั่นคงทางอารมณ์ (Resilience): กิจกรรมช่วยสร้างภูมิคุ้มกันทางจิตใจ ให้ผู้เรียนรับมือกับความกดดัน และล้มแล้วลุกเป็น",
      },
      {
        id: "vocational_skills",
        label:
          "4. ทักษะอาชีพ (Vocational Skills): มีการฝึกฝนทักษะที่สามารถนำไปประยุกต์ใช้ประกอบอาชีพหรือหารายได้ได้จริง",
      },
      {
        id: "work_ethic",
        label:
          "5. ทัศนคติที่ดีต่อการทำงาน (Work Ethic): ส่งเสริมให้ผู้เรียนมีความอดทน มุ่งมั่น รักการทำงาน และแก้ปัญหาเฉพาะหน้าได้",
      },
      {
        id: "social_responsibility",
        label:
          "6. จิตอาสาและความรับผิดชอบต่อสังคม (Social Responsibility): มีกิจกรรมที่ส่งเสริมการเห็นแก่ประโยชน์ส่วนรวม และการช่วยเหลือเกื้อกูลกัน",
      },
      {
        id: "active_citizenship",
        label:
          "7. ความเป็นพลเมืองดี (Active Citizenship): ผู้เรียนมีความเห็นอกเห็นใจผู้อื่น และรู้บทบาทหน้าที่ของตนเองในชุมชนและสังคม",
      },
    ],
  },
  {
    id: "local",
    title: "Local Lens",
    subtitle: "เขตพัฒนาพื้นที่เศรษฐกิจพิเศษชายแดนตาก - SEZ",
    objective:
      "เป้าหมาย: โปรเจกต์นี้ช่วยเตรียมความพร้อมให้เด็กในพื้นที่ อ.พบพระ / จ.ตาก เติบโตและอยู่รอดในเขตเศรษฐกิจพิเศษได้อย่างไร?",
    items: [
      {
        id: "border_trade",
        label:
          "1. การค้าชายแดน: มีการให้ความรู้หรือจำลองสถานการณ์เกี่ยวกับการค้าชายแดนระหว่างไทย-เมียนมา",
      },
      {
        id: "language_skills",
        label:
          "2. ทักษะทางภาษา: มีการพัฒนาทักษะทางภาษา เช่น ภาษาอังกฤษ ภาษาเมียนมา หรือภาษาชาติพันธุ์ เพื่อการสื่อสารในพื้นที่พหุวัฒนธรรม",
      },
      {
        id: "entrepreneurship",
        label:
          "3. การเป็นผู้ประกอบการ: มีการบ่มเพาะทักษะวิชาชีพและการเป็นผู้ประกอบการที่สอดคล้องกับความต้องการของพื้นที่",
      },
      {
        id: "tourism_service",
        label:
          "4. การท่องเที่ยวและการบริการ: สอดแทรกความรู้หรือทักษะด้านการส่งเสริมการท่องเที่ยว การบริการ หรือนันทนาการในท้องถิ่น",
      },
      {
        id: "digital_communication",
        label:
          "5. ทักษะดิจิทัลและการสื่อสาร: มีการใช้เทคโนโลยีดิจิทัล ภาษาคอมพิวเตอร์ หรือการทำสื่อโฆษณาประชาสัมพันธ์ในโปรเจกต์",
      },
      {
        id: "culture",
        label:
          "6. ประเพณีและวัฒนธรรม: มีการเรียนรู้ ทำความเข้าใจ หรือต่อยอดประเพณีและวัฒนธรรมอันหลากหลายในพื้นที่",
      },
      {
        id: "sustainability",
        label:
          "7. การอนุรักษ์อย่างยั่งยืน: มีการให้ความรู้หรือวางแผนเพื่อป้องกันผลกระทบทางสิ่งแวดล้อมและสังคมที่จะเกิดขึ้นจากการพัฒนา SEZ",
      },
    ],
  },
];
...
export const moduleTwoLessons = [
  ...
  {
    id: "m2-lesson-brief",
    title: "2.1 บทเรียน S-Design",
    type: "video",
    iconName: "PlayCircle",
    content: {
      videoUrl: "https://www.canva.com/design/DAHFggQuQrA/wjrRXDYOTSIPJ65KkbAlLA/view?embed",
      frameLabel: "S-Design Lesson Deck",
      externalUrl: "https://www.canva.com/design/DAHFggQuQrA/wjrRXDYOTSIPJ65KkbAlLA/view?embed",
      description:
